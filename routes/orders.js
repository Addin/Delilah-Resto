...
const orders = require('../middlewares/validOrder');
...
router.get('/', middlewaresUser.authenticateAdmin, (req, res) => {
  ...
  dataBase
    .query(orders, { type: sequelize.QueryTypes.SELECT })
    .then((data) => {
      res.json(data);
    })
...
router.put(
  ...
  (req, res) => {
    ...
    dataBase
      .query(query, { replacements: [code_status, id] })
      .then((data) => {
